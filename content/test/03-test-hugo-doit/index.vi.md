...
Với theme DoIt, có nhiều cách để viết summary:

- Dùng tham số summary trong yaml 
- Dùng tham số description trong yaml sau đó đặt `<!--more-->` ở đầu bài viết 
- Đặt `<!--more-->` ở nơi muốn cắt làm summary
...
Inline: {{< math >}}$\|\boldsymbol{x}\|_{0}=\sqrt[0]{\sum_{i} x_{i}^{0}}${{< /math >}}
...
{{< figure src="https://octodex.github.com/images/stormtroopocat.jpg" title="The Stormtroopocat" >}}

### 1.15. Notes:

{{< admonition type=notes title="Đây là một cái notes" open=false >}}
some thing
{{< /admonition >}}


### 1.16. Other Shorcodes
