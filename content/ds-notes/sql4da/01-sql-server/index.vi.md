...
Parch & Posey là CSDL về một công ty giả định, chuyên bán các loại giấy khác nhau. Mình lấy CSDL này từ khóa học [SQL for Data Analysis](https://www.udacity.com/course/sql-for-data-analysis--ud198).
...
Vì bài viết này được thực hiện trên *Jupyter Notebook* và hệ quản trị CSDL mình sử dụng là *SQL Server*, nên trước khi đi vào nội dung chính, ta cần kết nối Python với CSDL. Về các bước thực hiện thì mình đã có một bài viết chi tiết khác [ở đây](/jupyter-notebooks-for-sql-server/).
